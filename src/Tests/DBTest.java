...
class DBTest {
    ...
    void insertCotacao() throws PrecoInvalidoException, DataInvalidaException {
        ...
        Cotacao cotacao = new Cotacao(1, "22.22", "23/12/2023", "Parmalat");
    ...
    void deleteCotacao() throws PrecoInvalidoException, DataInvalidaException {
        ...
        Cotacao cotacao2 = new Cotacao(1, "22.22", "23/12/2023", "Parmalat");
        db.insertCotacao(cotacao);
    ...
    void deleteProduto() throws PrecoInvalidoException, DataInvalidaException {
        ...
        //INSERT COTACOES
        Cotacao cotacao1 = new Cotacao(1, "22.22", "23/12/2023", "Parmalat");
        db.insertCotacao(cotacao1);

        Cotacao cotacao2 = new Cotacao(2, "22.22", "23/12/2023", "Parmalat");
    ...
    void findProdutoById() {
        DB db = DB.newInstance();
        //PRODUTO 1
        Produto produto1 = new Produto("arroz", "camil", true, "alimento");
        db.insertProduto(produto1);

        //PRODUTO 2
        Produto produto2 = new Produto("arroz", "camil", true, "alimento");
